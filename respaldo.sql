...
CREATE TABLE `comentarios` (
  ...
  `publications_id` bigint unsigned NOT NULL,
  ...
  KEY `comentarios_plants_id_foreign` (`publications_id`),
  CONSTRAINT `comentarios_plants_id_foreign` FOREIGN KEY (`publications_id`) REFERENCES `publications` (`id`),
...
CREATE TABLE `eventos` (
  ...
  `urlimg` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `eventoscol` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `eventos` VALUES (2,'EVENTO 1','ESTE ES UN EVENTO','Luis Fernando Antonio de la Luz','Este es un evento que pasara en algún momento','2024-02-01','1a27629b-4f17-4600-9514-7e081f524997.png',NULL,'2024-02-17 01:57:45','2024-02-17 01:57:45',NULL);
...
INSERT INTO `migrations` VALUES (5,'2014_10_12_000000_create_users_table',1),(6,'2014_10_12_100000_create_password_resets_table',1),(7,'2019_08_19_000000_create_failed_jobs_table',1),(8,'2019_12_14_000001_create_personal_access_tokens_table',1),(9,'2022_10_17_034458_create_plants_table',2),(10,'2022_10_23_165752_add_urlimg_to_plants_table',3),(11,'2022_10_26_033743_create_posts_table',4),(12,'2022_11_18_051641_add_type_to_users_table',5),(13,'2022_11_18_051911_add_tylastnamep_users_table',5),(14,'2022_11_18_052048_add_lastnamem_users_table',5),(17,'2022_12_04_221704_add_username_to_users_table',6),(18,'2022_12_04_224805_create_comentarios_table',6),(20,'2022_12_04_232235_add_validacion_to_comentarios_table',7),(21,'2022_12_08_183932_create_likes_table',8);
...
CREATE TABLE `publications` (
  ...
  `formas_uso` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `distribucion` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `descripcion` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `usos` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `activos` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `publications` VALUES (1,'WQEQWEWQE','QWEQWEQWE','QWEQWEQE','QWEQWEWQE','QWEQWEQE','WQEQWEQWE','WQEQWEQWE','2d15b0a8-a7a7-4261-913c-50a5234dcb6d.jpg','2023-11-20 11:29:37','2023-11-20 11:29:37',NULL);
...
INSERT INTO `users` VALUES (1,'Administrador','Administrador',NULL,'admin@admin.com',NULL,'$2y$10$BPPf1NOuSdsZkZtWyQoQEuGB0E4XivEcIE/YsKSEBiGUEO5iHbK1e','okmqsmQSQUlVRBTTkFopx8kAHf4JZmUb3D8Lp9GWGbu2wzJxIYOXqo4Vp96N',2,'2022-11-23 08:26:55','2022-11-23 08:26:55',NULL);
...
-- Dump completed on 2024-02-16 15:10:47
